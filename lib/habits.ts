...
export const HABITS: Habit[] = [
  ...
  { id: "play-tt", name: "Play TT in evening", category: "extra", order: 26 },
  ...
  { id: "wake-up-early", name: "Wake up early", category: "daily", order: 24 },
  { id: "night-brush", name: "Night brush", category: "daily", order: 25 },
  { id: "learn-piano", name: "Learn piano", category: "extra", order: 27 },
  { id: "extra-mala", name: "Do extra mala", category: "extra", order: 28 },
  { id: "read-5am-club", name: "Read 5 am club book", category: "extra", order: 29 },
  { id: "content-creation", name: "Do content creation", category: "extra", order: 30 },
